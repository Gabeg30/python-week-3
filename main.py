...
# food = "tacos"
# number = "1"
# print(f'Once upon a time, thare was a {age} year old coder named {name}')
...
# moms_age = 87
# dads_age = 88
# print(moms_age + dads_age)
# #I can also find the datatype for the age variables
# print(type(moms_age))
# print(type(dads_age))
...
# age_of_hancockHighschool = input("what is the age of Hancock high school?")
# print(f"I am {age} and the age of my high school is {age_of_hancockHighschool}")
